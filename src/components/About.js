...
function About() {
  return (
    <div>
      ...
      <IconRow>
        <div class="iconButton"> <FontAwesomeIcon icon={faFileAlt} fixedWidth /> </div>
        <div class="iconButton"> <FontAwesomeIcon icon={faHeart} fixedWidth /> </div>
        <div class="iconButton"> <FontAwesomeIcon icon={faAngular} fixedWidth /> </div>
        <div class="iconButton"> <FontAwesomeIcon icon={faReact} fixedWidth /> </div>
        <div class="iconButton"> <FontAwesomeIcon icon={faGem} fixedWidth /> </div>
      </IconRow>
